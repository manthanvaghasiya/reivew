...
export async function generateReviewsAction(businessId: string, rating: number, selectedTags: string[] = []) {
  try {
    ...
    // Use gemini-1.5-flash as it's optimized for fast text tasks
