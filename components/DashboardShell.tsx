...
export default function DashboardShell({ children, businessName }: DashboardShellProps) {
  ...
  const navigation = [
    ...
    { name: "Branches", href: "/dashboard/branches", icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
    { name: "Customer Insights", href: "/dashboard/insights", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
  ];

  const creativeSuite = [
    { name: "Google Connect", href: "/dashboard/connect", icon: "M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" },
    ...
    { name: "Poster Studio", href: "/dashboard/poster-studio", icon: "M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" },
    { name: "SEO Posts", href: "/dashboard/posts", icon: "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" },
  ...
  const billing = [
    { name: "Token Top-ups", href: "/dashboard/billing", icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
    ...
    <div className="flex min-h-screen bg-[#050505] text-gray-200 print:bg-white print:text-black">
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-72 flex flex-col bg-[#0a0a0a] border-r border-white/5 transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 print:hidden ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
        ...
        <div className="flex-1 overflow-y-auto p-4 custom-scrollbar space-y-8">
          ...
          <div>
            <h3 className="px-4 text-[10px] font-bold uppercase tracking-widest text-gray-600 mb-3">Billing</h3>
            <nav className="space-y-1">
              {billing.map((item) => {
                const isActive = pathname === item.href;
                return (
